    ...
    <section className="py-32" ref={ref}>
      <div className="section-container">
        <motion.div
          ...
          <img src={appIcon} alt="Endless XR" className="w-32 h-32 md:w-40 md:h-40 rounded-3xl mx-auto mb-10" style={{ boxShadow: '0 0 30px rgba(139,92,246,0.4), 0 0 60px rgba(139,92,246,0.2), 0 0 100px rgba(139,92,246,0.1)' }} />
